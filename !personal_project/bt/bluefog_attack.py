"""
BlueFog Adapter Name Spoofing Attack
...
class BlueFogAttack:
    ...
    def _rotation_loop(self):
        ...
        print(f"[*] Starting BlueFog attack with {len(self.adapter_indices)} adapter(s)")
    ...
    def stop(self):
        """Stop the BlueFog attack and clean up."""
        self.running = False
...
def run_interactive():
    """Run BlueFog in interactive mode."""
    print("\n")
    print("╔════════════════════════════════════════╗")
    print("║       BlueFog Adapter Spoofing        ║")
