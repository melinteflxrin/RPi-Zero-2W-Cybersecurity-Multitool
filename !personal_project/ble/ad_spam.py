"""
Educational AD spam scaffold (non-operational).

This module mirrors the structure of the BLE tools in this project and borrows
the naming pattern from JammyTools sour.py, but intentionally omits any real
attack implementation.

For safety, packet/device attack logic is left empty on purpose.
"""
...
def main():
    """Command-line interface for the educational AD spam scaffold."""
    parser = argparse.ArgumentParser(
        description="Educational AD spam scaffold (non-operational)",
        epilog="Example: python -m ble.ad_spam -d hci0 hci1",
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["hci0"],
        help="Bluetooth HCI device(s) to reference (default: hci0)",
    )
